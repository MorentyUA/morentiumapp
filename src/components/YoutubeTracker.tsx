            ...
            <div className="bg-slate-800/80 backdrop-blur-md border border-white/10 p-6 rounded-3xl shadow-xl">
                ...
                <form onSubmit={handleSearch} className="relative">
                    <input
                        ...
                        className="w-full text-xs sm:text-sm bg-black/40 border border-white/10 rounded-2xl py-4 pl-12 pr-[4.5rem] text-white placeholder-slate-500 focus:outline-none focus:border-red-500 transition-colors shadow-inner"
                    />
